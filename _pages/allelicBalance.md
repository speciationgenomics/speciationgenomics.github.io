...
To check the heterozygotes, you can use the [script](https://github.com/speciationgenomics/scripts/blob/master/checkHetsIndvVCF.sh) originally written by David Marques and apply it on a dataset of SNPs. It takes a SNPs-only vcf file as input. It generates a plot for each individual, revealing potential contamination. Let's try it on a few samples that were RAD-sequenced:
...
## Fixing low-level contamination
